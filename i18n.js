(() => {
  const translations = {
    en: {
      ...
      aboutKicker: '02 / ABOUT ME', aboutPreview: 'Visual artist & video editor focused on motion graphics, event visuals, 3D and cinematic content.', moreAbout: 'MORE ABOUT ME →', close: 'CLOSE ×', project: 'PROJECT',
    ...
    zh: {
      ...
      aboutKicker: '02 / 关于我', aboutPreview: '专注于动态影像、活动视觉、3D 与电影感内容的视觉艺术家和视频剪辑师。', moreAbout: '了解更多 →', close: '关闭 ×', project: '项目',
    ...
    vi: {
      ...
      aboutKicker: '02 / VỀ TÔI', aboutPreview: 'Nghệ sĩ thị giác và dựng phim tập trung vào motion graphics, visual sự kiện, 3D và nội dung điện ảnh.', moreAbout: 'TÌM HIỂU THÊM →', close: 'ĐÓNG ×', project: 'DỰ ÁN',
